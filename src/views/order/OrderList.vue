			...
			<div class="order-list" v-for="d in list" slot="list">
				...
				<div class="order-foot flex flex-x-between flex-y-center">
					...
					<div class="flex flex-x-end">
						...
						<btn v-show="d.orderStatusId == 4 || d.orderStatusId == 5" name="再来一单" @click="aginOrder(d)"></btn>
						<btn v-show="d.orderStatusId == 4 || d.orderStatusId == 5" name="我要评价" @click="toEvaluate(d.id,d.sellerId,d.orderUmber)"></btn>
